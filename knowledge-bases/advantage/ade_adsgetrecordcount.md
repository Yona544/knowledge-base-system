...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TAdsTable.AdsGetRecordCount  Advantage TDataSet Descendant |  |  | Feedback on: Advantage Database Server 12 - TAdsTable.AdsGetRecordCount Advantage TDataSet Descendant ade\_Adsgetrecordcount Advantage Web Development > Advantage Delphi OData Client > Delphi OData Components > TODataSet / Dear Support Staff, |  |
...
Note If an index is active, this function works identically to [AdsGetKeyCount](ade_adsgetkeycount.htm) .
