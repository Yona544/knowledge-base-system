...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| system.columns  Advantage SQL Engine |  |  | Feedback on: Advantage Database Server 12 - system.columns Advantage SQL Engine master\_System\_columns Advantage SQL > System Views > Views > system.columns / Dear Support Staff, |  |
