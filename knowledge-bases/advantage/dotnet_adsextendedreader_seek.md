...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| AdsExtendedReader.Seek  Advantage .NET Data Provider |  |  | Feedback on: Advantage Database Server 12 - AdsExtendedReader.Seek Advantage .NET Data Provider dotnet\_Adsextendedreader\_seek Advantage .NET Data Provider > AdsExtendedReader Class > AdsExtendedReader Methods > AdsExtendedReader.Seek / Dear Support Staff, |  |
