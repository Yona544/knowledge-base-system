...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| AdsMgGetWorkerThreadActivity  Advantage Client Engine |  |  | Feedback on: Advantage Database Server 12 - AdsMgGetWorkerThreadActivity Advantage Client Engine ace\_Adsmggetworkerthreadactivity Advantage Web Development > Advantage Delphi OData Client > Delphi OData Components > TODataSet / Dear Support Staff, |  |
...
[Click Here](ace_advantage_management_api_examples.htm#adsmggetworkerthreadactivity_example)

See Also

[AdsMgConnect](ace_adsmgconnect.htm)

[ADS\_MGMT\_THREAD\_ACTIVITY](ace_ads_mgmt_thread_activity.htm)