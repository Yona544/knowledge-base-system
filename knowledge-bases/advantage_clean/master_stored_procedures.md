---
title: Master Stored Procedures
slug: master_stored_procedures
product: Advantage Database Server
component: Advantage
version: "12"
category: Reference
original_path_html: master_stored_procedures.htm
source: Advantage CHM
tags:
  - master
checksum: 6a0c1c0a9c31cae7dfe4480dcb6a8b5e46e56da0
---
...
SQL scripts are the recommended container type. Stored procedures written as other libraries are called Advantage Extended Procedures (AEPs). See the [Advantage Extended Procedures](master_advantage_extended_procedures.md) topic for more details on AEPs.

See the [SQL scripts](master_sql_script_overview.md) documentation for a full discussion of the Advantage scripting language.

Creating a Stored Procedure

Stored procedures can be created via the [CREATE PROCEDURE](master_create_procedure.md) statement or visually using the Advantage Data Architect (which is the recommended method). A data dictionary is required to use stored procedures.

When creating a new stored procedure, you define the input and output parameters the procedure will accept. These parameters can be any data type supported by the [ADT table format](master_table_adt.md).
